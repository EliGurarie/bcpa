---
title: "Using BCPA v. 1.3 on a one-dimensional variable"
author: "Elie Gurarie"
...
Perform the window sweep.  Note that you specify the response variable (`depth`) and the time varible (`time`):
